...
macro(add_qmake_external_project PROJECT PATH DEPENDENCIES CONFIGURATION_OPTIONS)
    ...
    set(CONFIGURE_COMMAND ${QT_PATH}/bin/qmake PREFIX=${${PROJECT}_INSTALL_PREFIX} INSTALL_PREFIX=${${PROJECT}_INSTALL_PREFIX} ${PATH} ${QMAKE_COMMON_CONFIGURATION_OPTIONS} ${CONFIGURATION_OPTIONS})
